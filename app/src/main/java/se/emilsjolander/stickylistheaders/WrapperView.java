...
/**
 * 
 * the view that wrapps a divider detail_travel_group_header and a normal list item. The listview sees this as 1 item
 * 
...
public class WrapperView extends ViewGroup {
	...
	void update(View item, View header, Drawable divider, int dividerHeight) {
		...
		//same logik as above but for the detail_travel_group_header
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//measure detail_travel_group_header or divider. when there is a detail_travel_group_header visible it acts as the divider
		if (mHeader != null) {
