...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	/**
	 * Will recycle detail_travel_group_header from {@link WrapperView} if it exists
	 */
	...
	/**
	 * Get a detail_travel_group_header view. This optionally pulls a detail_travel_group_header from the supplied
	...
	private View configureHeader(WrapperView wv, final int position) {
		...
		//if the detail_travel_group_header isn't clickable, the listselector will be drawn on top of the detail_travel_group_header
	...
	/** Returns {@code true} if the previous position has the same detail_travel_group_header ID. */
